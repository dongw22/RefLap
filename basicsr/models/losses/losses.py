...
class multi_VGGPerceptualLoss(torch.nn.Module):
    ...
    def forward(self, out1, out2, out3, gt1, feature_layers=[2]):
        ...
        per_loss1 = 0.01 * self.loss_fn(out1, gt1, feature_layers=feature_layers)
        per_loss2 = 0.01 * self.loss_fn(out2, gt2, feature_layers=feature_layers)
        per_loss3 = 0.01 * self.loss_fn(out3, gt3, feature_layers=feature_layers)
